...
> This is a generalization that collects patterns from the workflows used in https://github.com/iamgio/quarkdown[Quarkdown] and other personal projects.
...
* *Major-version tag alias:* extracts and pushes the
  major from the tag (`v2.3.4` -> `v2`), ideal for pinning versions in GitHub Actions (dogfooded in
link:.github/workflows/release.yml[this very action]).
